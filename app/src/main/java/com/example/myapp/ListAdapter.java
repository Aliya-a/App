...
public class ListAdapter extends BaseAdapter {
    ...
    private com.example.myapp.ViewHolder holder = null;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null){
            ...
            holder = new com.example.myapp.ViewHolder(convertView);
            convertView.setTag(holder);
        }
        else {
            holder = (com.example.myapp.ViewHolder)convertView.getTag();
        }
